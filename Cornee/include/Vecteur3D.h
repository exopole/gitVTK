...
public:
	...
	*/
	...
	/**
	* \fn Vecteur3D(Point pt)
	* \brief constructor of a vector
	* x = xx, y = xx, z = xx
	*/
	Vecteur3D(Point* pt) : x(pt->getX()), y(pt->getY()), z(pt->getZ()) {}
	...
	* x = xx, y = xx, z = xx
	*/
	Vecteur3D(Point* pt, Point* pt2) : x(pt2->getX() - pt->getX()), y(pt2->getY() - pt->getY()), z(pt2->getZ() - pt->getZ()) {}
